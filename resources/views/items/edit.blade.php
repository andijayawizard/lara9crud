                        ...
                        <form action="{{ route('categories.update', $item->id) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                                    value="{{ old('name', $item->name) }}" placeholder="Masukkan Nama Category">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('rgks') is-invalid @enderror" name="rgks"
                                    value="{{ old('rgks', $item->rgks) }}" placeholder="Ringkasan">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('ktrg') is-invalid @enderror" name="ktrg" rows="4" placeholder="Keterangan">{{ old('ktrg', $item->ktrg) }}</textarea>
